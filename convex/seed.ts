...
export const run = mutation({
    ...
    handler: async (ctx) => {
        ...
        // Insert Agents
        const agents = [
            { name: 'Manish', role: 'Founder', level: 'LEAD', status: 'active', avatar: '👨' },
            { name: 'Friday', role: 'Developer Agent', level: 'INT', status: 'active', avatar: '⚙️' },
            { name: 'Fury', role: 'Customer Researcher', level: 'SPC', status: 'active', avatar: '🔬' },
            { name: 'Jarvis', role: 'Squad Lead', level: 'LEAD', status: 'active', avatar: '🤖' },
            { name: 'Loki', role: 'Content Writer', level: 'SPC', status: 'active', avatar: '✍️' },
            { name: 'Pepper', role: 'Email Marketing', level: 'INT', status: 'active', avatar: '📧' },
            { name: 'Quill', role: 'Social Media', level: 'INT', status: 'active', avatar: '📱' },
            { name: 'Shuri', role: 'Product Analyst', level: 'SPC', status: 'active', avatar: '🔍' },
            { name: 'Vision', role: 'SEO Analyst', level: 'SPC', status: 'active', avatar: '🌐' },
            { name: 'Wanda', role: 'Designer', level: 'SPC', status: 'active', avatar: '🎨' },
            { name: 'Wong', role: 'Documentation', level: 'SPC', status: 'active', avatar: '📄' },
        ];
        ...
        await ctx.db.insert("activities", {
            ...
            message: "commented on \"Design Expansion Revenue Mechanics (SaaS Cheat Code)\"",
        });
    },
});
